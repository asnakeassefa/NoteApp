...
class _EditNotePageState extends State<EditNotePage> {
  ...
  void markTitleAsedited(String title) {
    setState(() {
      isedited = true;
    });
  }

  void markContentAsedited(String content) {
    setState(() {
      isedited = true;
    });
  }

  void markImportantAsedited() {
    setState(() {
